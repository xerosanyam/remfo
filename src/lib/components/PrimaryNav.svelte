...
<header
	class="fixed bottom-0 z-20 flex w-full flex-col border-r bg-white shadow-lg sm:top-0 sm:h-screen sm:w-48"
>
	...
	<details {open}>
		...
		<nav class="flex w-screen sm:mt-8 sm:w-48 sm:flex-col">
